...
import VisualProductSearch from "@/components/VisualProductSearch";
    ...
    <>
      ...
      <main className="min-h-screen flex flex-col items-center p-6 text-center">
        <motion.div
          ...
          className="max-w-4xl w-full space-y-12 pt-20"
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { title: "جستجوی بصری", icon: ImageIcon, color: "bg-amber-50", href: "#visual-search" },
        ...
        <div id="visual-search" className="w-full">
          <VisualProductSearch />
        </div>
      </main>
    </>

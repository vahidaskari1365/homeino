        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-xl bg-primary-foreground/5 border border-primary-foreground/10 flex items-center justify-center text-amber-200/80 hover:text-gold hover:border-gold/30 transition-all">
                <Globe size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-xl bg-primary-foreground/5 border border-primary-foreground/10 flex items-center justify-center text-amber-200/80 hover:text-gold hover:border-gold/30 transition-all">
                <Phone size={18} />
          ...
          <div>
            ...
            {["مبلمان", "فرش و قالی", "لوستر و روشنایی", "پرده", "کالای خواب", "دکور چوبی"].map((item) => (
              <a key={item} href="#" className="block text-amber-200/80 text-sm hover:text-gold transition-colors py-1.5">
                {item}
              </a>
            ))}
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-amber-200/80 text-sm">
              ...
              <div className="flex items-start gap-3 text-amber-200/80 text-sm">

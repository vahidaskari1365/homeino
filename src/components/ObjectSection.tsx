      ...
      {expanded && (
        <div className="border-t border-border">
          ...
          <div className="px-4 pb-3 flex gap-2">
            ...
            {!skipped && (
              <Button variant="ghost" size="sm" className="text-[10px] h-7 gap-1 text-destructive" onClick={onSkip}>
                <X size={10} /> حذف
              </Button>
            )}
            {skipped && (
              <Button variant="outline" size="sm" className="text-[10px] h-7 gap-1" onClick={onSkip}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-1.5 space-y-0.5">
                        <p className="text-[10px] font-medium line-clamp-1">{product.product_name}</p>
                        <p className="text-[10px] text-accent font-bold">{fmt(product.price)}</p>

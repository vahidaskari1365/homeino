...
const cards = [
  ...
  },
  {
    ...
    description: "یک اسکرین‌شات از پینترست، اینستاگرام یا هر سایتی آپلود کن. هومینو استودیو تک‌تک اشیاء را تشخیص می‌دهد و محصولات مشابه هومینو را پیدا می‌کند.",
  ...
  },
  {
    ...
    description: "بگذار هومینو استودیو بهترین مبلمان و دکوراسیون را بر اساس نوع فضا، بودجه و سبک تو پیشنهاد کند.",

...
export default function BadgesPage() {
  ...
  const { badges: earnedBadges, loading: userBadgesLoading } = useUserBadges();
  ...
  if (loading || userBadgesLoading || defsLoading) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {earnedBadges.length > 0 && (
          <Card className="p-6 bg-card border-border mt-6">
            <h2 className="font-bold mb-4">نشان‌های کسب شده</h2>
